...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Claude Skills — Bibliothèque de compétences IA premium" },
      ...
      { name: "author", content: "Claude Skills" },
      { property: "og:title", content: "Claude Skills — Bibliothèque de compétences IA premium" },
